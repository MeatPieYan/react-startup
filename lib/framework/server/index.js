...
class Pie {
  ...
  _loadMiddleware() {
    ...
    const _viewPath = this._applicationConfig.viewPath;
    const _routerPath = this._applicationConfig.routerPath;
    const _staticResourcePath = this._applicationConfig.staticResourcePath;
    const _clientRoutePath = this._applicationConfig.clientRoutePath;
